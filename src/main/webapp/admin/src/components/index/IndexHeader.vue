<template>
	<div class="navbar">
		<div class="title" :style='{"display":"block"}'>
			...
			<span class="title-name" :style='{"padding":"0 0 0 12px","lineHeight":"44px","fontSize":"20px","color":"rgba(0, 0, 0, 1)","float":"left","fontWeight":"600"}'>{{this.$project.projectName}}</span>
		</div>
		<div class="right" :style='{"position":"absolute","right":"20px","top":"8px","display":"flex"}'>
			...
			<div :style='{"cursor":"pointer","margin":"0 25px","lineHeight":"44px","color":"#333"}' v-if="this.$storage.get('role')!='管理员'" class="logout" @click="onIndexTap">退出到前台</div>
