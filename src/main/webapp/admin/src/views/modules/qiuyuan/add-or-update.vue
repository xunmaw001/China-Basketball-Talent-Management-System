	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="年龄段" prop="nianlingduan">
					<el-select :disabled="ro.nianlingduan" v-model="ruleForm.nianlingduan" placeholder="请选择年龄段" >
						<el-option
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="年龄段" prop="nianlingduan">
					<el-input v-model="ruleForm.nianlingduan"
						placeholder="年龄段" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="所在学校" prop="suozaixuexiao">
					<el-input v-model="ruleForm.suozaixuexiao" placeholder="所在学校" clearable  :readonly="ro.suozaixuexiao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="所在学校" prop="suozaixuexiao">
					<el-input v-model="ruleForm.suozaixuexiao" placeholder="所在学校" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="排名" prop="paiming">
					<el-input v-model="ruleForm.paiming" placeholder="排名" clearable  :readonly="ro.paiming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="排名" prop="paiming">
