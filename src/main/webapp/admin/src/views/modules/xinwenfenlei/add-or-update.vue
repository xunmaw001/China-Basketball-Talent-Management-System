<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="新闻分类" prop="xinwenfenlei">
					<el-input v-model="ruleForm.xinwenfenlei" placeholder="新闻分类" clearable  :readonly="ro.xinwenfenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="新闻分类" prop="xinwenfenlei">
					<el-input v-model="ruleForm.xinwenfenlei" placeholder="新闻分类" readonly></el-input>
				</el-form-item>
			</template>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xinwenfenlei/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xinwenfenleiCrossAddOrUpdateFlag = false;
						 this.parent.search();
