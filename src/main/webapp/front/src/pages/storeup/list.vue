...
<div :style='{"width":"1200px","padding":"20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","margin":"10px auto","position":"relative","background":"#fff"}'>
    <el-button :style='{"border":"0","cursor":"pointer","padding":"0 20px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"28px","background":"#4733B8","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="warning" size="mini" @click="backClick" class="el-icon-back">返回</el-button>
    <div v-if="storeupType==41" class="section-title" :style='{"margin":"10px 0","color":"#fff","textAlign":"center","background":"url(http://codegen.caihongy.cn/20220914/35861b89a8ff458f8ffc152f5d778e4c.png) center center/cover no-repeat","fontSize":"20px","lineHeight":"100px","height":"130px"}'>我的关注</div>
