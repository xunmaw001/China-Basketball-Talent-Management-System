...
<div :style='{"width":"1200px","padding":"20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","margin":"10px auto","position":"relative","background":"#fff"}'>
    <div class="section-title" :style='{"margin":"10px 0","color":"#fff","textAlign":"center","background":"url(http://codegen.caihongy.cn/20220914/35861b89a8ff458f8ffc152f5d778e4c.png) center center/cover no-repeat","fontSize":"20px","lineHeight":"100px","height":"130px"}'>在线留言</div>
