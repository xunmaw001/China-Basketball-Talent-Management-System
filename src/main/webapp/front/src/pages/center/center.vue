...
<div class="center-preview" :style='{"width":"1200px","margin":"10px auto","position":"relative","background":"#fff"}'>
	<div class="title" :style='{"margin":"10px 0","color":"#fff","textAlign":"center","background":"url(http://codegen.caihongy.cn/20220914/35861b89a8ff458f8ffc152f5d778e4c.png) center center/cover no-repeat","fontSize":"20px","lineHeight":"100px","height":"130px"}'>{{ title }}</div>
    ...
    <el-tabs tab-position="left" :style='{"boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","background":"#fff"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="100px">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"transparent"}' v-if="userTableName=='yonghu'" label="年龄" prop="nianling">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"transparent"}' v-if="userTableName=='yonghu'" label="头像">
            <el-upload
              ...
              <img :style='{"border":"1px dashed rgba(64, 158, 255, 1)","cursor":"pointer","color":"#3226BB","borderRadius":"6px","textAlign":"center","borderImage":"linear-gradient(90deg, rgba(50.000000819563866, 38.0000015348196, 187.00000405311584, 1), rgba(148.7414985895157, 148.7414985895157, 148.7414985895157, 1)) 1 1","width":"100px","fontSize":"32px","lineHeight":"100px","height":"100px"}' v-if="sessionForm.touxiang" :src="baseUrl + sessionForm.touxiang" class="avatar">
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"transparent"}' v-if="userTableName=='yonghu'" label="用户手机" prop="yonghushouji">
            <el-input v-model="sessionForm.yonghushouji" placeholder="用户手机" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"0","margin":"0"}'>
            <el-button :style='{"border":"0","cursor":"pointer","padding":"0","margin":"0 20px 0 0","borderColor":"#000","color":"rgba(255, 255, 255, 1)","outline":"none","borderRadius":"0","background":"#4733B8","borderWidth":"0 4px 0 0","width":"128px","lineHeight":"60px","fontSize":"16px","borderStyle":"solid","height":"60px"}' type="primary" @click="onSubmit('sessionForm')">更新信息</el-button>
            <el-button :style='{"cursor":"pointer","padding":"0","margin":"0","borderColor":"#4733B8","color":"#000","outline":"none","borderRadius":"0","background":"#D8D8D8","borderWidth":"0 4px 0 0","width":"128px","lineHeight":"60px","fontSize":"14px","borderStyle":"solid","height":"60px"}' type="danger" @click="logout">退出登录</el-button>
          </el-form-item>
        </el-form>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      if ('yonghu' == this.userTableName) {
        this.$set(this.sessionForm, 'yonghushouji', null);
      }
      ...
      if ('yonghu' == this.userTableName) {
        this.$set(this.rules, 'mima', [{ required: true, message: '请输入密码', trigger: 'blur' }]);
			...
			if ('yonghu' == this.userTableName) {
        this.$set(this.rules, 'yonghushouji', [{ required: false, validator: this.$validate.isMobile, trigger: 'blur' }]);
      }
